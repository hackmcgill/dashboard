...
> {
            ...
            <MaxWidthBox m={'auto'} maxWidth={'500px'}>
                ...
                <Formik
                    ...
                    initialValues={{
                        ...
                        linkedIn:
                            hackerDetails.application.portfolioURL.linkedIn,
                        personal:
                            hackerDetails.application.portfolioURL.personal,
    ...
    private renderFormik(fp: FormikProps<any>) {
        return (
            <Form onSubmit={fp.handleSubmit}>
                ...
                />
                <ErrorMessage component={FormikError} name="school" />
                <FastField
                    id="degree"
                    name={'degree'}
                ...
                <FastField
                    ...
                    required={true}
                />
                <ErrorMessage component={FormikError} name="graduationYear" />
                <FastField
                    id="major"
                    name={'major'}
                    inputType="major"
                    ...
                    required={true}
                />
                <ErrorMessage component={FormikError} name="major" />
                <FastField
                    id="gender"
                    name={'gender'}
                ...
                <FastField
                    ...
                    required={true}
                />
                <ErrorMessage component={FormikError} name="ethnicity" />
                <FastField
                    id="needsBus"
                    name={'needsBus'}
                ...
                <FastField
                    ...
                    required={true}
                />
                <ErrorMessage component={FormikError} name="github" />
                ...
                />
                <ErrorMessage component={FormikError} name="dropler" />
                <FastField
                    id="linkedIn"
                    name={'linkedIn'}
                    inputType="url"
                ...
                />
                <ErrorMessage component={FormikError} name="linkedIn" />
                ...
                />
                <ErrorMessage component={FormikError} name="personal" />
                <FastField
                    id="other"
                    name={'other'}
                    inputType="url"
                ...
                />
                <ErrorMessage component={FormikError} name="other" />
                <Field
                    id="resumeFile"
                    name="resumeFile"
                ...
                />
                <ErrorMessage component={FormikError} name="resumeFile" />
                <FastField
                    id="jobInterest"
                    name={'jobInterest'}
                    options={[
                    ...
                    required={true}
                />
                <ErrorMessage component={FormikError} name="jobInterest" />
                <FastField
                    id="skills"
                    name={'skills'}
                ...
                <FastField
                    ...
                    required={true}
                />
                <ErrorMessage component={FormikError} name="essay" />
                <FastField
                    id="comments"
                    name={'comments'}
                    component={TextareaComponent}
                    ...
                    required={false}
                />
                <ErrorMessage component={FormikError} name="comments" />
                <FastField
        ...
        handler
            .then((success: boolean) => {
                if (success) {
                    ...
                    toast.success(
                        `Account ${
                            mode === ManageApplicationModes.EDIT
                                ? 'edited'!
                                : 'created!'
                        }`
                    );
                    ...
                    toast.error(
                        `There was an error when submitting the application.`
                    );
                }
            })
    ...
    private async handleEdit(
        ...
        const account = acctResponse.data.data;
        const resumeLink = this.state.hackerDetails.application.portfolioURL
            .resume;
