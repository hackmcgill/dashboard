...
const TextareaComponent: React.StatelessComponent<ILinkComponentProp & FieldProps> = (props) => {
 ...
 */
function handleChange(props: ILinkComponentProp & FieldProps): (event: React.ChangeEvent<HTMLTextAreaElement>) => void {
