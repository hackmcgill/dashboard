...
const withHackerRedirect = <P extends {}>(Component: React.ComponentType<P>, options: IHackerDirectOptions = defaultOptions) =>
    class extends React.Component<P, { authState: authStates }> {
        ...
        constructor(props: any) {
            ...
            this.verification = options.AuthVerification || defaultOptions.AuthVerification;
        ...
        public render() {
            ...
            switch (authState) {
                ...
                case authStates.unauthorized:
                    return options.requiredAuthState ? (<Redirect to={FrontendRoute.HOME_PAGE} />) : <Component {...this.props} />;
                default:
                    return <div />;
            }
        }
