...
export const DROPLER_LINK_LABEL = 'Dribbble URL (optional)';
...
export const GITHUB_LINK_LABEL = 'GitHub URL (required)';
...
export const LINKEDIN_LINK_LABEL = 'LinkedIn URL (optional)';
