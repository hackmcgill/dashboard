...
import { Button, Form, FormDescription, H1, MaxWidthBox } from '../shared';
    ...
    constructor(props: IManageAccountContainerProps) {
        ...
        this.state = {
            ...
            accountDetails: {
                ...
                dietaryRestrictions: [],
                email:
                    getNestedProp(props, ['location', 'state', 'email']) || '',
                firstName: '',
                id: '',
                lastName: '',
                password:
                    getNestedProp(props, ['location', 'state', 'password']) ||
                    '',
                phoneNumber: '',
                pronoun: '',
                shirtSize: '',
        ...
        this.onDietaryRestrictionsChanged = this.onDietaryRestrictionsChanged.bind(
            this
        );
    ...
    public async componentDidMount() {
        ...
        if (mode === ManageAccountModes.EDIT) {
            try {
                ...
                accountDetails.birthDate = this.date2input(
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <DietaryRestrictionComponent
                        ...
                        onDietaryRestrictionsChanged={
                            this.onDietaryRestrictionsChanged
                        }
                        required={false}
                    />
                    <PronounInput
